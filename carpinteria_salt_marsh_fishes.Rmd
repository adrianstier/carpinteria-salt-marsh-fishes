...
enclosure_totals <- csm_enclosure %>%
 ...
 left_join(common_names, by = "species_code") %>%
 mutate(
   # Create clean labels for unknown species
   common_name = case_when(
     !is.na(common_name) ~ common_name,
     grepl("Unknown Species of", genus_name) ~ paste0("Unidentified ", species_name),
     genus_name != species_name ~ paste0(genus_name, " ", species_name),
     TRUE ~ paste0("Unidentified ", family, " sp.")
   ),
